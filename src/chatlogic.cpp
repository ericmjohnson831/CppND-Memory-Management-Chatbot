...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot chatBotExtra("../images/chatbot.png");
    chatBotExtra.SetChatLogicHandle(this);

    chatBotExtra.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(chatBotExtra));
}
